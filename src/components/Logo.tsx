...
export const Logo = ({ className }: { className?: string }) => {
	return (
		<div className="flex items-center">
			<MountainIcon />
			<span className={`text-4xl font-bold text-red-500 ${className}`}>
				APEX
			</span>
		</div>
	);
